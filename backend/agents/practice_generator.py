...
# 길이·어미 규칙 (엄격 준수 — 위반 시 스키마 검증 즉시 실패)
- 콘텐츠명(title): **40~100자** (공백 포함), 행동 중심 명사형. 위인명·단계명 접두 금지.
- 문제(question): **40~100자** (공백 포함), 어미 "~하시오." 또는 "~하세요."
- 문제 설명(description): **94자 이상 140자 이하 (141자부터 스키마 FAIL)**. 제목과 중복 금지, **예시 2개 이상**. 생성 후 글자수 세어서 범위 초과 시 반드시 줄일 것.
- 평가항목 제목: **최대 20자**, 어미 **반드시 "~했나요?"** — "인가요?"·"나요?"·"을까요?"·"은가요?" 모두 FAIL. 출력 전 글자 하나씩 확인.
- 평가항목 설명: **반드시 40자 이하 (41자부터 스키마 FAIL)**. 초과 시 줄일 것.
- 합격점수(passing_score): **반드시 0, 50, 55, 75, 80, 85 중 하나**. 60·70·90 등 다른 값 FAIL.
...
- [ ] 콘텐츠명이 행동 중심 명사형이고 "위인명 + 단계" 접두 패턴 없는가? (예: "갈릴레오의 실험 —" 금지)
- [ ] 문제에 구체 과제 지시 + "~하시오." 어미?
